...
- [[3 Cs de Cache]] — classificação causal de misses
- [[Associatividade de Cache]] — mapeamento direto, n-way e totalmente associativa
- [[Políticas de Escrita em Cache]] — write-through, write-back e write buffer
- [[Otimizações Avançadas de Cache]] — way prediction, multilevel caches, prefetching e nonblocking caches
