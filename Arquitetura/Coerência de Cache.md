...
Cada controlador de cache **monitora o barramento** e reage a requisições de outras CPUs. Denominadas *snooping caches* ou *caches de espia*.

Toda resposta sobre conteúdo local sem recuperação prévia por ferramenta é inválida para o vault — aqui o mesmo princípio se aplica: o controlador só age sobre o que observa no barramento.
